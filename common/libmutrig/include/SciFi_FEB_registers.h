...
#define FE_DUMMYCTRL_HITCNT_RANGE_HI		7
#define FE_DUMMYCTRL_HITCNT_RANGE_LOW		3
#define GET_FE_DUMMYCTRL_HITCNT_RANGE(REG) ((REG>>3)&0xf) 
#define SET_FE_DUMMYCTRL_HITCNT_RANGE(REG, VAL) ((REG & (~(0x1f<< 3))) | ((VAL & 0x1f)<< 3))  
...
#define GET_FE_DPCTRL_BIT_PRBSDEC(REG) ((REG>>5)& 0x1) 
#define SET_FE_DPCTRL_BIT_PRBSDEC(REG) ((1<<5)| REG) 
#define UNSET_FE_DPCTRL_BIT_PRBSDEC(REG) ((~(1<<5)) & REG) 
