...
set_instance_assignment -name IO_STANDARD "2.5 V" -to FPGA_Test[0]
set_instance_assignment -name IO_STANDARD "2.5 V" -to FPGA_Test[1]
set_instance_assignment -name IO_STANDARD "2.5 V" -to FPGA_Test[2]
set_instance_assignment -name IO_STANDARD "2.5 V" -to FPGA_Test[3]
set_instance_assignment -name IO_STANDARD "2.5 V" -to FPGA_Test[4]
set_instance_assignment -name IO_STANDARD "2.5 V" -to FPGA_Test[5]
set_instance_assignment -name IO_STANDARD "2.5 V" -to FPGA_Test[6]
set_instance_assignment -name IO_STANDARD "2.5 V" -to FPGA_Test[7]
