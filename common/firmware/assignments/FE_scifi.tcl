...
set_instance_assignment -name IO_STANDARD "2.5 V" -to o_fee_chip_rst[0]
...
set_location_assignment PIN_AP31 -to o_fee_spi_MISO[1]

#o_fee_spi_SCK=SPI_SCK_B
set_instance_assignment -name IO_STANDARD "1.8 V" -to o_fee_spi_SCK[1]
set_location_assignment PIN_AP30 -to o_fee_spi_SCK[1]
...
set_instance_assignment -name IO_STANDARD "2.5 V" -to o_fee_chip_rst[1]
set_location_assignment PIN_N26 -to o_fee_chip_rst[1]
