...
#define DATAGENERATOR_BIT_ENABLE_2		4
#define GET_DATAGENERATOR_BIT_ENABLE_2(REG) ((REG>>4)& 0x1) 
#define SET_DATAGENERATOR_BIT_ENABLE_2(REG) ((1<<4)| REG) 
#define UNSET_DATAGENERATOR_BIT_ENABLE_2(REG) ((~(1<<4)) & REG) 
...
#define DMA_CONTROL_REGISTER_W		0x05
