# qsys scripting (.tcl) file for reqfifo
package require -exact qsys 16.0

create_system {reqfifo}
...
set_instance_parameter_value fifo_0 {GUI_Width} {32}
set_instance_parameter_value fifo_0 {GUI_dc_aclr} {1}
set_instance_parameter_value fifo_0 {GUI_delaypipe} {5}
set_instance_parameter_value fifo_0 {GUI_diff_widths} {1}
set_instance_parameter_value fifo_0 {GUI_msb_usedw} {0}
set_instance_parameter_value fifo_0 {GUI_output_width} {16}
