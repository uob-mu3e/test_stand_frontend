...
class TilesFEB : public MutrigFEB{
   private:
      ...
      TilesFEB(FEBSlowcontrolInterface & feb_sc_, const char* equipment_name, const char* odb_prefix)
	:
   ...
   public:
      static TilesFEB* Create(FEBSlowcontrolInterface & feb_sc_, const char* equipment_name, const char* odb_prefix)
      {
