...
set_false_path -from {fe_block_v2:e_fe_block|sc_rx:e_sc_rx|o_ram_we} -to {mupix_block:e_mupix_block|mupix_datapath:e_mupix_datapath|mupix_datapath_reg_mapping:e_mupix_datapath_reg_mapping|o_reg_rdata[*]}
set_false_path -from {fe_block_v2:e_fe_block|sc_rx:e_sc_rx|o_ram_addr[*]} -to {mupix_block:e_mupix_block|mupix_datapath:e_mupix_datapath|mupix_datapath_reg_mapping:e_mupix_datapath_reg_mapping|o_reg_rdata[*]}
