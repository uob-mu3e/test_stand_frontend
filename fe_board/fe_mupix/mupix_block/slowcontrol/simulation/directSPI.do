...
add wave -noupdate -group direct_spi /mupix_ctrl_tb/e_mp_ctrl/gendirect_spi(0)/mp_ctrl_direct_spi_inst/*
add wave -noupdate -group direct_spi_fifo /mupix_ctrl_tb/e_mp_ctrl/gendirect_spi(0)/mp_ctrl_direct_spi_inst/direct_spi_fifo/*
