#ifndef __FE_SI5345_fe_v2_mutrig_H__
#define __FE_SI5345_fe_v2_mutrig_H__
...
#include "Si5345-v5-Registers_si1_mutrig.h"
...
struct si5345_t : si534x_t {
    ...
    void init(int force = 0) {
        ...
        if ( spi_slave==0 ) {
            si_t::init(si5345_revd_registers1_mutrig, sizeof(si5345_revd_registers1_mutrig) / sizeof(si5345_revd_registers1_mutrig[0]));
        }
...
#endif // __FE_SI5345_f2_v2_mutrig_H__
