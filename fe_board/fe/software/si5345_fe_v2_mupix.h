#ifndef __FE_SI5345_fe_v2_mupix_H__
#define __FE_SI5345_fe_v2_mupix_H__
...
#include "muedmTestbeamFEBSI2.h"        // optical clk from firefly, 625 MHz clk on systemclock_bottom

#include "Si5345-v5-Registers_si1_mupix.h"
...
struct si5345_t : si534x_t {
    ...
    void init(int force = 0) {
        ...
        if ( spi_slave==0 ) {
            si_t::init(si5345_revd_registers1_mupix, sizeof(si5345_revd_registers1_mupix) / sizeof(si5345_revd_registers1_mupix[0]));
        }
...
#endif // __FE_SI5345_f2_v2_mupix_H__
