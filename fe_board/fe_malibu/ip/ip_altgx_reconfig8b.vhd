...
-- ============================================================
-- File Name: ip_altgx_reconfig8b.vhd
-- Megafunction Name(s):
-- 			alt2gxb_reconfig
--
...
--alt2gxb_reconfig BASE_PORT_WIDTH=1 CBX_AUTO_BLACKBOX="ALL" DEVICE_FAMILY="Stratix IV" ENABLE_BUF_CAL="TRUE" ENABLE_CHL_ADDR_FOR_ANALOG_CTRL="TRUE" NUMBER_OF_CHANNELS=1 NUMBER_OF_RECONFIG_PORTS=1 READ_BASE_PORT_WIDTH=1 RECONFIG_FROMGXB_WIDTH=17 RECONFIG_TOGXB_WIDTH=4 busy reconfig_clk reconfig_fromgxb reconfig_mode_sel reconfig_togxb
...
--synthesis_resources = lpm_compare 3 lpm_counter 1 lpm_decode 1 lut 1 reg 102 
 ...
 ENTITY  ip_altgx_reconfig8b_alt_dprio_2vj IS 
	 PORT 
	 ( 
 ...
 END ip_altgx_reconfig8b_alt_dprio_2vj;

 ARCHITECTURE RTL OF ip_altgx_reconfig8b_alt_dprio_2vj IS
 ...
 END RTL; --ip_altgx_reconfig8b_alt_dprio_2vj
...
--synthesis_resources = alt_cal 1 lpm_compare 3 lpm_counter 1 lpm_decode 1 lut 1 reg 114 
 ...
 ENTITY  ip_altgx_reconfig8b_alt2gxb_reconfig_ksv IS 
	 PORT 
	 ( 
		 busy	:	OUT  STD_LOGIC;
 ...
 END ip_altgx_reconfig8b_alt2gxb_reconfig_ksv;

 ARCHITECTURE RTL OF ip_altgx_reconfig8b_alt2gxb_reconfig_ksv IS
	 ...
	 END COMPONENT;
	 COMPONENT  ip_altgx_reconfig8b_alt_dprio_2vj
	 PORT
	 ( 
		address	:	IN  STD_LOGIC_VECTOR(15 DOWNTO 0);
		busy	:	OUT  STD_LOGIC;
 ...
 BEGIN
	...
	dprio :  ip_altgx_reconfig8b_alt_dprio_2vj
	  PORT MAP ( 
 ...
 END RTL; --ip_altgx_reconfig8b_alt2gxb_reconfig_ksv
--VALID FILE
...
END ip_altgx_reconfig8b;


ARCHITECTURE RTL OF ip_altgx_reconfig8b IS
	...
	ATTRIBUTE clearbox_defparam OF RTL: ARCHITECTURE IS "base_port_width=1;cbx_blackbox_list=-lpm_mux;enable_chl_addr_for_analog_ctrl=TRUE;intended_device_family=Stratix IV;number_of_channels=1;number_of_reconfig_ports=1;read_base_port_width=1;enable_buf_cal=true;reconfig_fromgxb_width=17;reconfig_togxb_width=4;";
	...
	COMPONENT ip_altgx_reconfig8b_alt2gxb_reconfig_ksv
	PORT (
			reconfig_clk	: IN STD_LOGIC ;
			reconfig_fromgxb	: IN STD_LOGIC_VECTOR (16 DOWNTO 0);
...
BEGIN
	...
	ip_altgx_reconfig8b_alt2gxb_reconfig_ksv_component : ip_altgx_reconfig8b_alt2gxb_reconfig_ksv
	PORT MAP (
...
-- Retrieval info: GEN_FILE: TYPE_NORMAL ip_altgx_reconfig8b.vhd TRUE
-- Retrieval info: GEN_FILE: TYPE_NORMAL ip_altgx_reconfig8b.inc FALSE
-- Retrieval info: GEN_FILE: TYPE_NORMAL ip_altgx_reconfig8b.cmp TRUE
-- Retrieval info: GEN_FILE: TYPE_NORMAL ip_altgx_reconfig8b.bsf FALSE
-- Retrieval info: GEN_FILE: TYPE_NORMAL ip_altgx_reconfig8b_inst.vhd FALSE
