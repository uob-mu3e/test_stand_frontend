...
--synthesis_resources = stratixiv_hssi_calibration_block 1 stratixiv_hssi_clock_divider 4 stratixiv_hssi_cmu 1 stratixiv_hssi_pll 5 stratixiv_hssi_rx_pcs 4 stratixiv_hssi_rx_pma 4 stratixiv_hssi_tx_pcs 4 stratixiv_hssi_tx_pma 4 
 ...
 ENTITY  ip_altgx_alt4gxb IS 
	 GENERIC 
	 (
        effective_data_rate : positive := 6250; -- Mbps
        input_clock_frequency : string := "125.0"; -- MHz
 ...
 END ip_altgx_alt4gxb;

 ARCHITECTURE RTL OF ip_altgx_alt4gxb IS
 ...
 BEGIN
	...
	rx_cdr_pll0 :  stratixiv_hssi_pll
	  GENERIC MAP (
		...
		inclk0_input_period => input_clock_period,
		input_clock_frequency => input_clock_frequency & " MHz",
		m => m_divider,
		n => 1,
		pfd_clk_select => 0,
		pll_type => "RX CDR",
...
ARCHITECTURE RTL OF ip_altgx IS
...
BEGIN
	...
	GENERIC MAP (
        ...
        input_clock_period => input_clock_period,
        m_divider => m_divider,
...
-- Retrieval info: GEN_FILE: TYPE_NORMAL ip_altgx.vhd TRUE
-- Retrieval info: GEN_FILE: TYPE_NORMAL ip_altgx.ppf TRUE
-- Retrieval info: GEN_FILE: TYPE_NORMAL ip_altgx.inc FALSE
-- Retrieval info: GEN_FILE: TYPE_NORMAL ip_altgx.cmp TRUE
-- Retrieval info: GEN_FILE: TYPE_NORMAL ip_altgx.bsf FALSE
-- Retrieval info: GEN_FILE: TYPE_NORMAL ip_altgx_inst.vhd FALSE
