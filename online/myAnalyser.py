import sys
sys.path.append('/midas_v1/mu3eSummer22/packages/midas/python/')
...
# FILE I/O
mfile = midas.file_reader.MidasFile("run00009.mid")
...
plt.scatter(range(1,len(data["PWM"])+1), data["PWM"], s=10, c='orangered', marker = 'x', label='PWM')
