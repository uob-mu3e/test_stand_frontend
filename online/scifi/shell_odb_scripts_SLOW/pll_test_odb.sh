...
odbedit -d "/Equipment/SciFi/Settings/ASICs/TDCs/${i}" -c "set vncnt                           40"
...
odbedit -d "/Equipment/SciFi/Settings/ASICs/TDCs/${i}" -c "set vnpcp                           24"
...
odbedit -d "/Equipment/SciFi/Settings/ASICs/TDCs/${i}" -c "set vnhitlogic                      32"
