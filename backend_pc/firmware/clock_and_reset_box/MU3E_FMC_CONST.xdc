...
set_property -dict { PACKAGE_PIN L8  IOSTANDARD LVCMOS33 } [get_ports { Q1_CLK0_GTREFCLK_PAD_P_IN }]; #FMC_D4 Sch=MGT_CLK0_P
set_property -dict { PACKAGE_PIN L7  IOSTANDARD LVCMOS33 } [get_ports { Q1_CLK0_GTREFCLK_PAD_N_IN }]; #FMC_D5 Sch=MGT_CLK0_N
set_property -dict { PACKAGE_PIN N8  IOSTANDARD LVCMOS33 } [get_ports { Q1_CLK1_GTREFCLK_PAD_P_IN }]; #FMC_B20 Sch=MGT_CLK1_P
set_property -dict { PACKAGE_PIN N7  IOSTANDARD LVCMOS33 } [get_ports { Q1_CLK1_GTREFCLK_PAD_N_IN }]; #FMC_B21 Sch=MGT_CLK1_N


set_property -dict { PACKAGE_PIN N4  IOSTANDARD LVCMOS33 } [get_ports { TXP_OUT[0] }]; #DP5_C2M_P FMC_A38 Sch=MGT0_P
set_property -dict { PACKAGE_PIN N3  IOSTANDARD LVCMOS33 } [get_ports { TXN_OUT[0] }]; #DP5_C2M_N FMC_A39 Sch=MGT0_N
set_property -dict { PACKAGE_PIN M2  IOSTANDARD LVCMOS33 } [get_ports { TXP_OUT[1] }]; #DP6_C2M_P FMC_B36 Sch=MGT1_P
set_property -dict { PACKAGE_PIN M1  IOSTANDARD LVCMOS33 } [get_ports { TXN_OUT[1] }]; #DP6_C2M_N FMC_B37 Sch=MGT1_N
set_property -dict { PACKAGE_PIN P2  IOSTANDARD LVCMOS33 } [get_ports { TXP_OUT[2] }]; #DP4_C2M_P FMC_A34 Sch=MGT2_P
set_property -dict { PACKAGE_PIN P1  IOSTANDARD LVCMOS33 } [get_ports { TXN_OUT[2] }]; #DP4_C2M_N FMC_A35 Sch=MGT2_N
set_property -dict { PACKAGE_PIN L4  IOSTANDARD LVCMOS33 } [get_ports { TXP_OUT[3] }]; #DP7_C2M_P FMC_B32 Sch=MGT3_P
set_property -dict { PACKAGE_PIN L3  IOSTANDARD LVCMOS33 } [get_ports { TXN_OUT[3] }]; #DP7_C2M_N FMC_B33 Sch=MGT3_N
set_property -dict { PACKAGE_PIN T2  IOSTANDARD LVCMOS33 } [get_ports { TXP_OUT[4] }]; #DP3_C2M_P FMC_A30 Sch=MGT4_P
set_property -dict { PACKAGE_PIN T1  IOSTANDARD LVCMOS33 } [get_ports { TXN_OUT[4] }]; #DP3_C2M_N FMC_A31 Sch=MGT4_N
set_property -dict { PACKAGE_PIN K2  IOSTANDARD LVCMOS33 } [get_ports { TXP_OUT[5] }]; #DP8_C2M_P FMC_B28 Sch=MGT5_P
set_property -dict { PACKAGE_PIN K1  IOSTANDARD LVCMOS33 } [get_ports { TXN_OUT[5] }]; #DP8_C2M_N FMC_B29 Sch=MGT5_N
set_property -dict { PACKAGE_PIN U4  IOSTANDARD LVCMOS33 } [get_ports { TXP_OUT[6] }]; #DP2_C2M_P FMC_A26 Sch=MGT6_P
set_property -dict { PACKAGE_PIN U3  IOSTANDARD LVCMOS33 } [get_ports { TXN_OUT[6] }]; #DP2_C2M_N FMC_A27 Sch=MGT6_N
set_property -dict { PACKAGE_PIN J4  IOSTANDARD LVCMOS33 } [get_ports { TXP_OUT[7] }]; #DP9_C2M_P FMC_B24 Sch=MGT7_P
set_property -dict { PACKAGE_PIN J3  IOSTANDARD LVCMOS33 } [get_ports { TXN_OUT[7] }]; #DP9_C2M_N FMC_B25 Sch=MGT7_N


set_property -dict { PACKAGE_PIN AC24  IOSTANDARD LVCMOS33 } [get_ports { EEPROM_SCL }]; #FMC_C30 Sch=FMC_SCL
set_property -dict { PACKAGE_PIN AD24  IOSTANDARD LVCMOS33 } [get_ports { EEPROM_SDA }]; #FMC_C31 Sch=FMC_SDA
set_property -dict { PACKAGE_PIN G18   IOSTANDARD LVCMOS33 } [get_ports { EEPROM_GA0 }]; #FMC_K22 Sch=FMC_GA0
set_property -dict { PACKAGE_PIN F18   IOSTANDARD LVCMOS33 } [get_ports { EEPROM_GA1 }]; #FMC_K23 Sch=FMC_GA1


set_property -dict { PACKAGE_PIN D13  IOSTANDARD LVCMOS33 } [get_ports { FMC_SCL }]; #FMC_K38 Sch=SCL
set_property -dict { PACKAGE_PIN D12  IOSTANDARD LVCMOS33 } [get_ports { FMC_SDA }]; #FMC_K37 Sch=SDA

set_property -dict { PACKAGE_PIN H12  IOSTANDARD LVCMOS33 } [get_ports { TX_MGT_RST_L }]; 	#FMC_K35 Sch=TX_MGT_RST 	OUT
set_property -dict { PACKAGE_PIN H11  IOSTANDARD LVCMOS33 } [get_ports { TX_MGT_INT_L }]; 	#FMC_K34 Sch=TX_MGT_INT		IN
set_property -dict { PACKAGE_PIN J12  IOSTANDARD LVCMOS33 } [get_ports { TX_MGT_SLCT_L }]; 	#FMC_K32 Sch=TX_MGT_SLCT	OUT
set_property -dict { PACKAGE_PIN J11  IOSTANDARD LVCMOS33 } [get_ports { TX_MGT_PRSNT_L }]; #FMC_K31 Sch=TX_MGT_PRSNT	IN
set_property -dict { PACKAGE_PIN E13  IOSTANDARD LVCMOS33 } [get_ports { FF_RX_INT_L }]; 	#FMC_K29 Sch=FF_RX_INT 		IN
set_property -dict { PACKAGE_PIN F12  IOSTANDARD LVCMOS33 } [get_ports { FF_TX_INT_L }]; 	#FMC_K28 Sch=FF_TX_INT 		IN
set_property -dict { PACKAGE_PIN G28  IOSTANDARD LVCMOS33 } [get_ports { TX_CLK_RST_L }]; 	#FMC_K19 Sch=TX_CLK_RST 	OUT
set_property -dict { PACKAGE_PIN B25  IOSTANDARD LVCMOS33 } [get_ports { TX_CLK_INT_L }]; 	#FMC_K17 Sch=TX_CLK_INT		IN
set_property -dict { PACKAGE_PIN C25  IOSTANDARD LVCMOS33 } [get_ports { TX_CLK_SLCT_L }]; 	#FMC_K16 Sch=TX_CLK_SLCT	OUT
set_property -dict { PACKAGE_PIN N22  IOSTANDARD LVCMOS33 } [get_ports { TX_CLK_PRSNT_L }]; #FMC_K14 Sch=TX_CLK_PRSNT	IN
set_property -dict { PACKAGE_PIN N30  IOSTANDARD LVCMOS33 } [get_ports { CLK_INTR_L }]; 	#FMC_K11 Sch=INTR			IN
