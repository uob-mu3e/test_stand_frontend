...
## LEDs
set_property -dict {PACKAGE_PIN T28 IOSTANDARD LVCMOS33} [get_ports {leds[0]}]
set_property -dict {PACKAGE_PIN V19 IOSTANDARD LVCMOS33} [get_ports {leds[1]}]
set_property -dict {PACKAGE_PIN U30 IOSTANDARD LVCMOS33} [get_ports {leds[2]}]
set_property -dict {PACKAGE_PIN U29 IOSTANDARD LVCMOS33} [get_ports {leds[3]}]
set_property -dict {PACKAGE_PIN V20 IOSTANDARD LVCMOS33} [get_ports {leds[4]}]
set_property -dict {PACKAGE_PIN V26 IOSTANDARD LVCMOS33} [get_ports {leds[5]}]
set_property -dict {PACKAGE_PIN W24 IOSTANDARD LVCMOS33} [get_ports {leds[6]}]
set_property -dict {PACKAGE_PIN W23 IOSTANDARD LVCMOS33} [get_ports {leds[7]}]
...
set_property -dict {PACKAGE_PIN AH24 IOSTANDARD LVCMOS33} [get_ports phy_rstb]
...
## PMOD Header JC
set_property -dict { PACKAGE_PIN AC26  IOSTANDARD LVCMOS33 } [get_ports { adc_cs_o }]; #IO_L19P_T3_13 Sch=jc[1]
#set_property -dict { PACKAGE_PIN AJ27  IOSTANDARD LVCMOS33 } [get_ports { jc[1] }]; #IO_L20P_T3_13 Sch=jc[2]
set_property -dict { PACKAGE_PIN AH30  IOSTANDARD LVCMOS33 } [get_ports { adc_data_i }]; #IO_L18N_T2_13 Sch=jc[3]
set_property -dict { PACKAGE_PIN AK29  IOSTANDARD LVCMOS33 } [get_ports { adc_clk_o }]; #IO_L15P_T2_DQS_13 Sch=jc[4]
...
#set_property -dict { PACKAGE_PIN AK28  IOSTANDARD LVCMOS33 } [get_ports { SDA }]; #IO_L20N_T3_13 Sch=jc[10]
...
set_property -dict { PACKAGE_PIN D12  IOSTANDARD LVCMOS33 } [get_ports { SDA }]; 		#FMC_HB17 Sch=SDA				INOUT
set_property -dict { PACKAGE_PIN D13  IOSTANDARD LVCMOS33 } [get_ports { SCL }]; 		#FMC_HB17 Sch=SCL				OUT

create_clock -period 8.000 [get_ports Q1_CLK1_GTREFCLK_PAD_P_IN]
create_clock -period 8.000 [get_ports Q1_CLK0_GTREFCLK_PAD_P_IN]

set_property PACKAGE_PIN N7 [get_ports Q1_CLK1_GTREFCLK_PAD_N_IN]
set_property PACKAGE_PIN N8 [get_ports Q1_CLK1_GTREFCLK_PAD_P_IN]
set_property PACKAGE_PIN L7 [get_ports Q1_CLK0_GTREFCLK_PAD_N_IN]
set_property PACKAGE_PIN L8 [get_ports Q1_CLK0_GTREFCLK_PAD_P_IN]

##---------- Set placement for gt0_gtx_wrapper_i/GTXE2_CHANNEL ------
set_property LOC GTXE2_CHANNEL_X0Y2 [get_cells gtx_reset_firefly_support_i/U0/gtx_reset_firefly_init_i/gtx_reset_firefly_i/gt0_gtx_reset_firefly_i/gtxe2_i]
##---------- Set placement for gt1_gtx_wrapper_i/GTXE2_CHANNEL ------
set_property LOC GTXE2_CHANNEL_X0Y3 [get_cells gtx_reset_firefly_support_i/U0/gtx_reset_firefly_init_i/gtx_reset_firefly_i/gt1_gtx_reset_firefly_i/gtxe2_i]
##---------- Set placement for gt2_gtx_wrapper_i/GTXE2_CHANNEL ------
set_property LOC GTXE2_CHANNEL_X0Y4 [get_cells gtx_reset_firefly_support_i/U0/gtx_reset_firefly_init_i/gtx_reset_firefly_i/gt2_gtx_reset_firefly_i/gtxe2_i]
##---------- Set placement for gt3_gtx_wrapper_i/GTXE2_CHANNEL ------
set_property LOC GTXE2_CHANNEL_X0Y5 [get_cells gtx_reset_firefly_support_i/U0/gtx_reset_firefly_init_i/gtx_reset_firefly_i/gt3_gtx_reset_firefly_i/gtxe2_i]
##---------- Set placement for gt4_gtx_wrapper_i/GTXE2_CHANNEL ------
set_property LOC GTXE2_CHANNEL_X0Y6 [get_cells gtx_reset_firefly_support_i/U0/gtx_reset_firefly_init_i/gtx_reset_firefly_i/gt4_gtx_reset_firefly_i/gtxe2_i]
##---------- Set placement for gt5_gtx_wrapper_i/GTXE2_CHANNEL ------
set_property LOC GTXE2_CHANNEL_X0Y7 [get_cells gtx_reset_firefly_support_i/U0/gtx_reset_firefly_init_i/gtx_reset_firefly_i/gt5_gtx_reset_firefly_i/gtxe2_i]
##---------- Set placement for gt6_gtx_wrapper_i/GTXE2_CHANNEL ------
set_property LOC GTXE2_CHANNEL_X0Y8 [get_cells gtx_reset_firefly_support_i/U0/gtx_reset_firefly_init_i/gtx_reset_firefly_i/gt6_gtx_reset_firefly_i/gtxe2_i]
##---------- Set placement for gt7_gtx_wrapper_i/GTXE2_CHANNEL ------
set_property LOC GTXE2_CHANNEL_X0Y9 [get_cells gtx_reset_firefly_support_i/U0/gtx_reset_firefly_init_i/gtx_reset_firefly_i/gt7_gtx_reset_firefly_i/gtxe2_i]
